<template>
    <div style="width: 100%;">
        ...
        <h5 class="text-primary  title p-2 bg-light  mb-2">Chapter Content</h5>
        <div class="form-group row">
            <b-col sm="6 mt-2 mb-0">
                <label for="font-size">Font-Size</label>
                <multiselect v-model="toc_chap_content.fontSize" :options="toc_chap_content_fontsize.map(item => item.value)">
                </multiselect>
            </b-col>
            <b-col sm="6 mt-2 mb-0">
                <label for="font-weight">Font-Weight</label>
                <multiselect v-model="toc_chap_content.fontWeight" :options="toc_chap_content_fontweight.map(item => item.value)">
                </multiselect>
            </b-col>
            <b-col sm="6 mt-2 mb-0">
                <label for="color">Color</label>
        ...
        <h5 class="text-primary  title p-2 bg-light   mb-2">Leader</h5>
        <div class="form-group row">
            <b-col sm="6 mt-2 mb-0">
